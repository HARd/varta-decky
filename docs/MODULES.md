...
Оскільки система автоматично знаходить ваші файли під час збірки, вам не потрібно вносити зміни в ядро плагіна. Щоб додати свій модуль, дотримуйтесь наступних кроків:
